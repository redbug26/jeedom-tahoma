...
function addCmdToTable(_cmd) {
	...
	*/
    ...
    if (init(_cmd.type) == 'info') {
        ...
        tr += '<span><label class="checkbox-inline"><input type="checkbox" class="cmdAttr" data-size="mini" data-l1key="eventOnly"' + disabled + ' />{{Ev̬nement}}</label></span> ';
        ...
        tr += '</div>';
        tr += '</div>';
        tr += '<select class="cmdAttr form-control tooltips input-sm" data-l1key="value" style="display : none;margin-top : 5px;margin-right : 10px;" title="{{La valeur de la commande vaut par d̩faut la commande}}">';
